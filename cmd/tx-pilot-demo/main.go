...
func main() {
	...
	switch *scenario {
	case "normal":
		runCLI(base, []string{"-memo", "tx-pilot-demo-normal"})
	case "expired":
		runCLI(base, []string{"-memo", "tx-pilot-demo-expired", "-inject-expired"})
	case "low-tip":
		runCLI(base, []string{"-memo", "tx-pilot-demo-low-tip", "-tip", "1"})
	default:
